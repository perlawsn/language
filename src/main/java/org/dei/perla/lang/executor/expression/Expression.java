...
public abstract class Expression {
     ...
     *
     * <p>
     * The binding operation may throw a BindingException if the type of the
     * attributes passed as parameter are incompatible with the operations
     * being performed.
     *
     ...
     * passed as parameter.
     */
    public final Expression bind(Collection<Attribute> atts,
            List<Attribute> bound) throws BindingException {
        Errors err = new Errors();
        Expression e = doBind(atts, bound, err);
        if (!err.isEmpty()) {
            throw new BindingException(err.toString());
        }
        return e;
    }
     ...
     * passed as parameter.
     */
    protected abstract Expression doBind(Collection<Attribute> atts,
